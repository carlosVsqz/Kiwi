...
const StyledPostStardard = styled(PostStardard)`margin-bottom: ${60 / 14}rem;`;

const StyledPostStardardFull = styled(PostStardardFull)`margin-bottom: ${20 / 14}rem;`;

const ToggleViewSidebarCulture = ({
  theme,
  defaultView,
  authorView,
}: {
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-7 col-lg-8 order-md-1">
            <Breadcrumb>
              ...
              <BreadcrumbItem href="/ciudad/historia">Ciudad</BreadcrumbItem>
            </Breadcrumb>
...
export default ToggleViewSidebarCulture;
