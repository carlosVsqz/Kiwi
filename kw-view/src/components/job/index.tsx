...
import { handleGetJob } from '@store/thunk/job';
...
const JobLayout = () => {
  ...
  const { data, fetching, meta, loadingMore } = useSelector((state: AppState) => state.job.list);
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-12 col-md-8 col-lg-9">
          <JobHeader getCurrentSort={(val) => setCurrentSort(val)} getCurrentView={(val) => setCurrentView(val)} />
          {fetching ? (
            <Loading />
          ) : (
