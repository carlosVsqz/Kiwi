...
const PostTabFeatureTop = ({ theme }: { theme?: ThemeVariation }) => {
  ...
  return (
    <div className="news-block -feature-top">
            ...
            <div className="col-12" d-sm-none>
              {data.slice(0, 1).map((item, index) => (
                <StyledPostStardardFull
                  ...
                  theme={theme}
                  data={item}
                  className="-large -horizontal news-block-post-item"
                />
              ))}
            </div>
...
export default PostTabFeatureTop;
