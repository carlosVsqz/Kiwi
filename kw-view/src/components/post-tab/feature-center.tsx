...
const PostTabFeatureCenter = ({ theme }: { theme?: ThemeVariation }) => {
  ...
  return (
    <div className="news-block -feature-center">
      <div className="container">
        ...
        {fetching ? (
          ...
          <div className="row ">
            <div className="col-12 col-md-6 col-md-12 col-lg-6 order-lg-2 d-none d-lg-block">
              {data.slice(0, 1).map((item, index) => (
                <PostStardardFull
                  ...
                  data={item}
                  hideButton
                  className="-center -no-content-padding news-block-post-item -big"
                />
              ))}
            </div>
            <div className="col-12 col-sm-6 col-md-6 col-lg-3 order-md-1">
              {data.slice(1, 3).map((item, index) => (
                <StyledPostStardard
                  ...
                  data={item}
                  hideButton
                  className="-center -no-content-padding news-block-post-item -small"
                />
              ))}
            </div>
            <div className="col-12 col-sm-6 col-md-6 col-lg-3 order-md-3">
...
export default PostTabFeatureCenter;
